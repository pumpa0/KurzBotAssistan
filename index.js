...
const starts = async (kurr = new WAConnection()) => {
    ...
    kurr.on('chat-update', async (message) => {
        ...
        ownerNumber = ["6285731855426@s.whatsapp.net","6285731855426@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "6285731855426@s.whatsapp.net"
...
if (!welkom.includes(anu.jid)) return
		try {
		    fkontakk = { key: {
		    fromMe: false,
		    participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '6285731855426-6285731855426@g.us' } : {})
		    },
		    message: {
		    "contactMessage":{"displayName":fake,"vcard":"BEGIN:VCARD\nVERSION:3.0\nN:2;han;;;\nFN:han\nitem1.TEL;waid=6285731855426:+62 81220670449\nitem1.X-ABLabel:Mobile\nEND:VCARD"
		     }}}
...
sendButImage(mdata.id, teks, 'Sering nimbrung dan baca rules grup ya', img, [{buttonId: 'mam', buttonText: {displayText: 'Welcome kak 👋'}, type: 1}], {thumbnail: img, "contextInfo": {mentionedJid: [num]}, quoted: {"key": {"fromMe": false,"participant": "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6285731855426-1616169743@g.us","inviteCode": "mememteeeekkeke","groupName": "P", "caption": `hanz`, 'jpegThumbnail': fs.readFileSync('./media/thumb.jpg')}}}})
...
"message": {
"groupInviteMessage": {
"groupJid": "6285731855426-1620319322@g.us",
"inviteCode": "FDnHRof3iIV1MfoW5vlMKQ",
"groupName": "Hanz",
